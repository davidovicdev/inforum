...
@section('content')
    ...
    <div class="mt-5 border rounded p-5 d-flex justify-content-between">
        ...
        <div class="h5 mt-5">
            ...
            <p>I'm student of College of Information and Communication Technologies "Visoka ICT" located in Belgrade.</p>
            <p>Currently I am working for Prodyna in their Workademy as Junior Software Engineer / IT Consultant related in
                C# / .NET</p>
            <p>PHP + Laravel opened the door for me as Backend developer and brought me my first job. </p>
            <p>Laravel is currently my favorite framework.</p>
            <p>This project represents the final project for my college.</p>
        </div>
    </div>
@endsection
